...
export async function GET(
  ...
  // Try a live universal lookup via Ship24 first, before falling back to our own records.
  ...
  if (/^[A-Z0-9]{8,}$/.test(cleaned)) {
    ...
    try {
      ...
      // Ship24 not configured, or no data for this number — fall back to our own records below.
    }
  }
